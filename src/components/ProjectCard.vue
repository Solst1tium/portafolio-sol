<template>
  <article
    class="bg-bg-card border border-border rounded-xl overflow-hidden flex flex-col
  ...
  >
    ...
    <div class="relative h-55 overflow-hidden bg-bg-dark">
      ...
      <!-- Overlay hover -->
      <div
        class="absolute inset-0 bg-bg-dark/85 flex items-center justify-center gap-4
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="border-2 border-primary text-primary px-5 py-2.5 rounded-lg font-semibold
                 text-sm hover:bg-primary hover:text-white transition-colors"
        >
          Código
        </a>
      </div>
      ...
      <span
        ...
        class="absolute top-3 right-3 bg-primary text-white px-3 py-1 rounded-full
    ...
    <div class="p-6 flex flex-col flex-1">
      ...
      <ul v-if="project.highlights" class="mb-4 space-y-1.5">
        <li
          ...
          :key="h"
          class="text-text-secondary text-[0.85rem] pl-4 relative
